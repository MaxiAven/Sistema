...
namespace Sistema.Web.Controllers
{
    public class ProvinciasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion")] Provincia provincia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descripcion")] Provincia provincia)
        {
            if (id != provincia.Id)
            {
                return NotFound();
