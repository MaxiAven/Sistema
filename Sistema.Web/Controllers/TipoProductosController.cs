...
namespace Sistema.Web.Controllers
{
    public class TipoProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion")] TipoProducto tipoProducto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descripcion")] TipoProducto tipoProducto)
        {
